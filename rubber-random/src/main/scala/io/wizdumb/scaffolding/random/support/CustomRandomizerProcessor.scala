package io.wizdumb.scaffolding.random.support

import java.lang.reflect.Field
import java.util.UUID

import io.wizdumb.scaffolding.random.predicate._
import io.wizdumb.scaffolding.random.support.annotations.CustomRandomizer
...
class CustomRandomizerProcessor extends AnnotationUtils {
    override val basePackages: Seq[String] = Seq("io.wizdumb.scaffolding")
