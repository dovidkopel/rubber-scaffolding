...
import io.wizdumb.scaffolding.random.core.RubberRandom.{MaxRecursionCountName, RecursionEnabledName}
import io.wizdumb.scaffolding.random.exceptions.{MaxRecursiveException, RecursionDisabledException}
