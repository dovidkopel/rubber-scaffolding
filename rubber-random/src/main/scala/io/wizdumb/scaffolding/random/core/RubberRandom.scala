package io.wizdumb.scaffolding.random.core

import io.wizdumb.scaffolding.config._
import io.wizdumb.scaffolding.random.core.RubberRandom.ProtectedPackagesName
import io.wizdumb.scaffolding.random.predicate._
import io.wizdumb.scaffolding.random.strategy.{FieldGeneratingStrategy, GeneratingStrategy}
import io.wizdumb.scaffolding.random.support.{AnnotationProcessor, CustomRandomizerProcessor}
import io.wizdumb.scaffolding.random.types.{CollectionTypes, ParameterizedTypeReference, TypeContainer}
import io.wizdumb.scaffolding.random.{Parameter, RandomProvider}
...
abstract class RubberRandom(
                               val basePackages: Seq[String] = Seq("io.wizdumb.scaffolding"),
