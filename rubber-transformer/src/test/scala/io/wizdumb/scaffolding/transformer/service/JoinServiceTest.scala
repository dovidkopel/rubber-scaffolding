...
import io.wizdumb.scaffolding.config.{ConfigName, ConfigurationUtils}
import io.wizdumb.scaffolding.transformer.function.impl.DateTimeSequential
import io.wizdumb.scaffolding.transformer.join.JoinKeys
import io.wizdumb.scaffolding.transformer.{InputA, InputB, InputC, OutputC}
...
class JoinServiceTest extends Logging {
    ...
    @ComponentScan(Array("io.wizdumb.scaffolding.random.*", "io.wizdumb.scaffolding.transformer.*"))
