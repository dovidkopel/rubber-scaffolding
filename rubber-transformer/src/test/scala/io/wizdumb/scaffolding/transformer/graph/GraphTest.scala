package io.wizdumb.scaffolding.transformer.graph

import java.nio.file.Files

import com.fasterxml.jackson.databind.ObjectMapper
import org.apache.commons.lang3.{RandomStringUtils, RandomUtils}
import io.wizdumb.scaffolding.graph.{GraphAppConfiguration, GraphFactoryService}
import io.wizdumb.scaffolding.spark.RDDService
import io.wizdumb.scaffolding.transformer.graph.nodes.{EdgeContainer, ElementContainer, VertexContainer}
import io.wizdumb.scaffolding.transformer.graph.reader.GraphMLUtils
import io.wizdumb.scaffolding.transformer.graph.rules._
import io.wizdumb.scaffolding.transformer.graph.traverser.BreadthFirstGraphTraverser
import io.wizdumb.scaffolding.transformer.{Mailman, Person, Worker}
...
@ComponentScan(Array("io.wizdumb.scaffolding.transformer.*", "io.wizdumb.scaffolding.random.*"))
...
class GraphTest {
    ...
    def testSimple {
        ...
        <graphml>
            <graph>
                <node id="1">
                    <data key="_clazz">io.wizdumb.scaffolding.transformer.Person</data>
                ...
                <edge id="99" source="1" target="2">
                    <data key="_clazz">io.wizdumb.scaffolding.transformer.FriendsWith</data>
                </edge>
