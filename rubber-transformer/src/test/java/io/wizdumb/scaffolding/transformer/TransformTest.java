...
import io.wizdumb.scaffolding.config.ConfigName;
import io.wizdumb.scaffolding.config.ConfigurationUtils$;
import io.wizdumb.scaffolding.random.core.JavaRubberRandom;
import io.wizdumb.scaffolding.transformer.function.Direction;
import io.wizdumb.scaffolding.transformer.function.impl.DateTimeSequential;
import io.wizdumb.scaffolding.transformer.function.impl.LongSequential;
import io.wizdumb.scaffolding.transformer.join.PartialJoin$;
import io.wizdumb.scaffolding.transformer.service.*;
import io.wizdumb.scaffolding.transformer.service.adapter.TransformerAdapter;
import io.wizdumb.scaffolding.transformer.service.adapter.XSDAdapter;
import io.wizdumb.scaffolding.transformer.service.transformations.TransformationsImpl;
...
public class TransformTest {
    ...
    @ComponentScan({
        "io.wizdumb.scaffolding.random.*",
        "io.wizdumb.scaffolding.transformer.*"
    })
    static class Conf {
        @Bean
