...
import io.wizdumb.scaffolding.graph.GraphFactoryService
import io.wizdumb.scaffolding.transformer.graph.generator.GraphScenarioGenerator
import io.wizdumb.scaffolding.transformer.graph.nodes.NodeRepository
import io.wizdumb.scaffolding.transformer.graph.reader.{GraphMLNode, GraphReaderOpts, GraphScenarioReader}
import io.wizdumb.scaffolding.transformer.graph.rules.RuleConditionOptions
import io.wizdumb.scaffolding.transformer.graph.traverser.{BreadthFirstGraphTraverser, GraphTraverser}
...
object GraphUtils {
    ...
    val rubberRandom = new io.wizdumb.scaffolding.random.core.RubberRandomImpl()
