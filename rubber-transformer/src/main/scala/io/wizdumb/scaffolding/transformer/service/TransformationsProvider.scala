...
import io.wizdumb.scaffolding.transformer.service.transformations.{OrderImpl, TransformationImpl, TransformationsImpl}
...
object TransformationsProvider {
    ...
    type OrderAnnotation = io.wizdumb.scaffolding.transformer.support.Order
