...
import io.wizdumb.scaffolding.transformer.join.JoinFilter.JoinTypeName
import io.wizdumb.scaffolding.transformer.join._
...
trait JoinService extends TransformationsProvider {
    ...
    val JoinsAnnotation: Class[io.wizdumb.scaffolding.transformer.support.Joins] = classOf[io.wizdumb.scaffolding.transformer.support.Joins]
