...
import io.wizdumb.scaffolding.knowledge.context.SimpleKnowledgeContext
import io.wizdumb.scaffolding.knowledge.criteria.Numeric.{GreaterThan, LessThan, SequentialIncrement}
import io.wizdumb.scaffolding.knowledge.rule.{CriteriaContainer, RuleCompiler}
